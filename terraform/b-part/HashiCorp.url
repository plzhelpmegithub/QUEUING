# QUEUING B-part Terraform - FULL SYNC (v3)
# Fixes: iam:GetRole is also blocked for this account.
# EKS module now builds IAM role ARNs directly from the
# account ID (no IAM API calls at all) instead of looking
# roles up via data source.
# Run this FROM INSIDE the terraform folder.
# Usage: .\sync_terraform_v3.ps1
...
Write-Host "Done. IAM lookups removed - ARNs built directly."
