...
function route() {
  ...
  currentCleanup = null;
  // A modal (e.g. sold-out dialog) lives outside `container`, in document.body,
  // so clearing the container alone leaves it on screen — silently blocking
  // every click on the next page underneath its full-screen overlay.
  closeModal();
  container.innerHTML = '';
