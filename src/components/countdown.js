// 카운트다운 / 서버 시계 / 예매오픈 타이머 컴포넌트.
// mountCountdown: 범용 카운트다운 (clock / mmss / deadline 포맷 지원).
// mountServerClock: 현재 서버 시간 1초 단위 표시.
// mountBookingCountdown: 24시간 이상이면 D-N 뱃지, 이내면 HH:MM:SS 카운트다운으로 자동 전환.
